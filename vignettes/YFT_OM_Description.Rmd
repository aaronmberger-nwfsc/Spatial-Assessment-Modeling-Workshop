...
The previous version of the YFT OM ([Dunn et al. (2020)](https://github.com/carenbarcelo-NOAA/Spatial-Assessment-Modeling-Workshop/blob/main/Background/Dunn%2C%20Hoyle%2C%20Datta%202020%20SPM%20YFT%20OM.pdf)) did not include stochasticity in recruitment. We introduced stochasticity into the YFT OM used in this simulation experiment by introducing process error in recruitment across space (spatial apportionment) and time (year class strength; YCS). Thus, simulated observations were generated for 100 different realizations of the OM, integrating both process and observation sources of error. 
