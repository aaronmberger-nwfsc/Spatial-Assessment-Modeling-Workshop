...
#_Bmark_years: beg_bio, end_bio, beg_selex, end_selex, beg_relF, end_relF, beg_recr_dist, end_recr_dist, beg_SRparm, end_SRparm (enter actual year, or values of 0 or -integer to be rel. endyr)
 256 256 249 256 249 256 1 256 1 256
...
257  #FirstYear for caps and allocations (should be after years with fixed inputs) 
0 # stddev of log(realized catch/target catch) in forecast (set value>0.0 to cause active impl_error)
0 # Do West Coast gfish rebuilder output (0/1) 
256 # Rebuilder:  first year catch could have been set to zero (Ydecl)(-1 to set to 1999)
256 # Rebuilder:  year for current age structure (Yinit) (-1 to set to endyear+1)
