...
Publications stemming from the experiment and workshop (to date) include a contrast of the estimation models applied to the Yellowfin OM ([Goethel et al., 2024](https://onlinelibrary.wiley.com/doi/pdf/10.1111/faf.12819)) and a synthesis of contemporary spatial stock assessment software ([Berger et al., 2024](https://www.sciencedirect.com/science/article/pii/S0165783624000729)).  
